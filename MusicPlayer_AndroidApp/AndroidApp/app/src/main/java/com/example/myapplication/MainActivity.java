...
//                    String URL = "http://192.168.1.106:8080/AndroidProject/servlet/LoginServlet";
                    String URL = "http://" + ip_Address + ":8080/AndroidProject/servlet/LoginServlet";
...
//                                     System.out.println(response.getBoolean("result"));
                                    ...
                                    if (response.getBoolean("result")) {
                                        ...
                                        Toast.makeText(MainActivity.this, "Login Denied HHH", Toast.LENGTH_LONG).show();
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    Toast.makeText(MainActivity.this, "Login Denied WWW", Toast.LENGTH_LONG).show();
                                }
                            }
                        ...
                        e.printStackTrace();
                        Toast.makeText(MainActivity.this, "Login Denied AAA", Toast.LENGTH_LONG).show();
                    }
