...
public class Temp_History_Data_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.temp_history_data);

        home_imageBtn = findViewById(R.id.home_btn);
        home_imageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Temp_History_Data_Activity.this, Analyze_Data_Activity.class));
        ...
        more_analyze_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Temp_History_Data_Activity.this, Temp_Sector_Graph_Activity.class));
        ...
        web_view.loadUrl("http://" + sp.getString("IP_Address", "") + ":8080/EP5/temp.html");
