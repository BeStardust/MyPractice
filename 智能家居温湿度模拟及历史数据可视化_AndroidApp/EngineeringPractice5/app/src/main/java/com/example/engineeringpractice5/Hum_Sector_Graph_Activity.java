...
public class Hum_Sector_Graph_Activity extends Activity {
    ImageButton back_btn;
    private WebView web_view;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.hum_sector_graph);
        back_btn = findViewById(R.id.back_btn);
        back_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Hum_Sector_Graph_Activity.this,Hum_History_Data_Activity.class));
        ...
        web_view.loadUrl("http://" + sp.getString("IP_Address", "") + ":8080/EP5/humSectorGraph.html");
